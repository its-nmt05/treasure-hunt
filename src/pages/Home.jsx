      ...
      <Card>
        <CardBody>
          <p>
            ...
            <br />
            <br />
            Surma is a rapidly evolving AI, as you get closer and closer to the kill switch, he imitates defensive mechanisms within the immune system and ramps up his defenses - simultaneously
            rushing the Federation servers with T-bots designed to destroy what they cannot absorb. Just before the last question, Surma starts breaking down, asking you to end his misery as he ends
            you. If you manage to solve it in time, the killswitch activates and Surma's alter dies - triggering a final monologue from the Federation server admins, explaining that Surma's attacks
