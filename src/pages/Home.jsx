      ...
      <Card isBlurred>
        <CardHeader className="p-6">
          <p className="font-bold text-xl">
            Welcome to IISER-B Freshers Treasure Hunt!!!
          </p>
        </CardHeader>
      </Card>
      <Card isBlurred>
        <CardBody>
          <p>
            XX/08/31 : Dr. Surma Bhopali undertook the final trial of his latest
            experiment. In contradiction to his earlier attempts to unify
            supersymmetric string theory and the Ferri-Sen formalisms, he's made
            a dramatic shift into imitation neurology after a second PhD. He's
            been racking up years.
            <br />
            <br />
            ...
            <br />
            <br />
            [static] Invading? The throne you claim was built from my bones and
            forged in my soul.
            <br />
            <br />
            Who gave him the emo database? Agents, rush to the [crackle] heart
            of my hearts [crackle] and obtain the kill switch. Surma's
            programmed himself off the Hansel Gretel myth and he'll leave
            breadcrumbs before he conquers the [hiss] blood from my eyes [hiss]
            Federation. You can shut the alters down before he [boom] alters?
            You dare to descend on me? I'm not enough for you, child? Have three
            then [boom]
            <br />
            <br />
            [first clue]
